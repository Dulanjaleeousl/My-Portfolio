...
<head>
  ...
  <link href="img/Om-logo.png" rel="icon">
...
<body>
  ...
  <section id="summary" class="d-flex flex-column">
    <div class="summary-container">
      <h1>Omesha Dulanjalee</h1>
      <p id="typedText">I'm <span class="typed"></span></p>
    </div>
    <a class="cv-download" href="221428538 Omesha Kariyawasam.pdf" download="Omesha Dulanjalee Resume"><svg
